              ...
              <div className="imagesBody">
                ...
                <div className="imgText">
                  <span className="ImgHeading">
                    <p>Explore the great selection </p>{" "}
                  </span>
                  <span className="ImgPara">
                    {" "}
            ...
            <div className="ThreeImg">
              <div className="imagesBody">
                ...
                <div className="imgText">
                  ...
                  <span className="ImgPara">
                    {" "}
                    <p> Chance of winning € 1,000 daily</p>{" "}
                  </span>
                  <div className="NavLinkss">
            ...
            <div className="part1">
              <div className="left">
                ...
                <div className="content">
                  <p>15:50 Lingfield</p>
                  <p>
                    € 355,435 <AiFillYoutube />{" "}
                  </p>
                </div>
              </div>
              <div className="right">
                <p>
                  Starting in <IoIosArrowForward />{" "}
                </p>
              </div>
            </div>
            <div className="part2">
